...
phi = c(1.2, -0.8)
factor.wge(phi = phi)
x = gen.arima.wge(n = 200, phi = phi, d = 1)
```
...
```{r}
phi = c(1.2, -0.8)
x = gen.arima.wge(n = 200, phi = phi, d = 2)
```
...
phi = c(1.2, -0.8)
x = gen.arima.wge(n = 200, phi = phi, d = 0, s = 4)
```

This has even more wandering compared to 'b'. This is a non-stationary model and does not have a seasonal component.
