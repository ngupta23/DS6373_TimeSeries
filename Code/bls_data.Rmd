...
Data from BLS website using code from Code from Jonathan Regenstein
...
```{r}
pull = fromJSON(paste0("https://api.bls.gov/publicAPI/v2/timeseries/data/CES0000000001?registrationkey=", key, "&catalog=true&startyear=2001&endyear=2020")) 
