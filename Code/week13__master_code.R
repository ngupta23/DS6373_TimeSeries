...
# Using forecast Sunspots (we dont know what the future sunspots will be. Hence we need to forecast these as well)
...
fit.mlp
plot(fit.mlp)
# For xreg, combine the 29 known values for sunspot to the 8 forecasted sunspot values
